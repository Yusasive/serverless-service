...
export class Updatecontentservice1753743612243 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "content_items" ADD "image_base64" text`
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "content_items" DROP COLUMN "image_base64"`
    );
    // await queryRhhunner.query(`ALTER TABLE "content_items" ADD CONSTRAINT "FK_content_items_section_id" FOREIGN KEY ("section_id") REFERENCES "content_sections"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
  }
} 
